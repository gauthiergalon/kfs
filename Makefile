...
KERNEL_SRCS := kernel/kernel.c kernel/terminal.c kernel/gdt.c kernel/idt.c kernel/isr.c kernel/pic.c kernel/keyboard.c kernel/stack.c lib/printk.c lib/strlen.c
